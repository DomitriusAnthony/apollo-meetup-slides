...
<CodeImage src={require('file-loader!./images/query.png')} width="900px" height="400px" />
...
<CodeImage src={require('file-loader!./images/mutation3.png')} width="900px" height="400px" />
...
# Query 
--- 
<CodeImage src={require('file-loader!./images/queryHOC.png')} width="40%" height="" />
